 ...
 * @Version 1.0
 */
public class GewayChangeModel extends BasePage implements Serializable {
    private static final Long   serialVersionUID = 1233224533101145L;


    public GewayChangeModel(){
