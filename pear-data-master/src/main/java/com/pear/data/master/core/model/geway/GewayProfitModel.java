...
/**
 * @Description 通道收益数据的实体属性Bean
 * @Author yoko
 * @Date 2021/1/20 16:17
 * @Version 1.0
 */
public class GewayProfitModel extends BasePage implements Serializable {
    private static final long   serialVersionUID = 123323334021546L;

    public GewayProfitModel(){
